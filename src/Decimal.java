...
public class Decimal {
	 ...
	 *  The conversion is done in two steps: decimal string to decimal number, then
	...
	/**
	 *  This method does actual conversion of a decimal number to a binary string
	 *  The algorithm was derived from the decimal to hex string method above
	 * @param decimal
	 * @return
	 */
